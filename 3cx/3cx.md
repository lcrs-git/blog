...
（一）安装环境
  ...
  3CX安装很简单，如果你想快速体验。直接在一台WINDOWS server上点击EXE安装包，然后一直下一步..就可以快速完成安装了。 正常的话，你什么问题都不会遇到。  
...
有意思是,3CX还可以安装在树莓派上。一个树莓派可以部署一套16并发,满足50个人使用的3CX。这一环境经过3CX官方测试超过半年，具有极客精神的朋友千万不要错过。
