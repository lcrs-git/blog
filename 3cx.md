...
一、安装3CX系统前的准备工作
（一）安装的网络环境
3CX安装很简单，如果你想快速体验。直接在一台WINDOWS server上点击3CX的EXE安装包。然后一直下一步..就可以快速完成安装了。有很大的可能性，你什么问题都不会遇到。但是如果你们公司是一家大型集团公司，整个IT网络具有一定的复杂性。那我还是建议你读一读下面这篇文章。可以帮助你日后部署的过程中少走很多弯路。
